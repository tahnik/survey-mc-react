...
class page16 extends Component {
    ...
    render() {
        ...
        var questions = [
            { id: this.props.fields.one, one: 'An allocated desk in an open plan setting', two: 'An unassigned desk, with access to quiet space'},
            { id: this.props.fields.two,  one: 'A shared desk in a shared office', two: 'An unassigned desk, with access to quiet space'},
            { id: this.props.fields.three,  one: 'An shared desk in an open plan setting', two: 'An unassigned desk, with access to quiet space'},
            ...
            { id: this.props.fields.eight,  one: 'Space in a shared office, with access to multifunctional meeting space (e.g., village green)', two: 'Space in an open plan setting with access to single purpose meeting space (closed rooms, white boards, access to VC)'},
            { id: this.props.fields.nine,  one: 'Space in a shared closed office, without access to alternative closed spaces', two: 'Space in an open plan environment with access to private space for phone calls and VC'},
            ...
            { id: this.props.fields.twelve,  one: 'Access to single purpose meeting space but no alternative closed spaces', two: 'Access to multifunctional meetings space (e.g., village green) and private space for making phone calls'},
            ...
            { id: this.props.fields.fifteen,  one: 'Access to private space for phone calls and VC but no defined social space', two: 'Access to defined social space but no closed space for private phone calls or VC'},
