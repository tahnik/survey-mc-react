    ...
    render() {
        ...
        return(
            ...
            <div className="col-md-8 offset-xs-2">
                ...
                <div id="NoCo" onDrop={(e) => this.drop(e)} onDragOver={(e) => this.allowDrop(e)} className="col-md-4" style={{ height: '40vh' }}>
                ...
                <div id="SOCO" onDrop={(e) => this.drop(e)} onDragOver={(e) => this.allowDrop(e)} className="col-md-4" style={{ height: '40vh' }}>
                    <div className="col-md-10 col-md-offset-1" style={{ height: '50px', paddingTop: '7px' , backgroundColor: 'skyblue', position: 'absolute', bottom: 0,  borderRadius: '5px' }}>
                        <h6 className="text-xs-center">Somewhat confidential</h6>
                    </div>
                </div>
                <div id="HICO" onDrop={(e) => this.drop(e)} onDragOver={(e) => this.allowDrop(e)} className="col-md-4" style={{ height: '40vh' }}>
                    <div className="col-md-10 col-md-offset-1" style={{ height: '50px', paddingTop: '7px' , backgroundColor: 'skyblue', position: 'absolute', bottom: 0,  borderRadius: '5px' }}>
